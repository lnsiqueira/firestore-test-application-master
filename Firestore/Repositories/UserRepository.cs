...
public class UserRepository
{
    ...
    public UserRepository()
    {
        ...
        _repository = new BaseRepository<User>(Collection.User);
    }
    ...
    //     var query = _repository._firestoreDb.Collection(Collection.User.ToString()).WhereIn(nameof(User.CityFrom), cities);
