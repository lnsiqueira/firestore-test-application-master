...
public class BaseRepository<T> : IBaseRepository<T>
{
    ...
    public BaseRepository(Collection collection)
    {
       ...
       // var filepath = @"/Users/lucianonunesdesiqueira/Downloads/sdlc-staging-firebase-adminsdk-297h1-20953352d6.json";
         var filepath = @"sdlc-staging-firebase-adminsdk-297h1-20953352d6.json";
        Environment.SetEnvironmentVariable("GOOGLE_APPLICATION_CREDENTIALS", filepath);
        _firestoreDb = FirestoreDb.Create("sdlc-staging"); 
